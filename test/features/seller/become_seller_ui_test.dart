...
void main() {
  testWidgets('terms note is visible and names ThriftLine Terms and Conditions', (
    tester,
  ) async {
  ...
  testWidgets('only the six allowed ID types are offered', (tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
          body: Wrap(
            children: [
              for (final type in SellerIdType.values) Chip(label: Text(type.label)),
            ],
          ),
        ),
      ),
