              ...
              SliverAppBar(
                ...
                actions: [
                  IconButton(
                    ...
                    onPressed: () =>
                        showThriftSnackBar(context, 'Link copied!'),
                  ),
                ],
              ),
              SliverToBoxAdapter(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            _expanded
                                ? product.description
                                : '${product.description.substring(0, product.description.length.clamp(0, 80))}...',
                          ...
                          if (product.hasActiveBid) ...[
                            ...
                            ThriftCard(
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    'Current Bid: ${formatCurrency(product.currentBid ?? 0)}',
                                  ...
                                  ThriftButton(
                                    ...
                                    onPressed: () =>
                                        _confirmBid(context, product, minBid),
                                  ),
                                  const SizedBox(height: 8),
                                  Text(
                                    'Starting: ${formatCurrency(product.startingBid ?? product.price)} • Increment: ${formatCurrency(product.bidIncrement)}',
  ...
  void _confirmBid(BuildContext context, product, double minBid) {
    ...
    ThriftBottomSheet.show(
      ...
      child: Column(
        children: [
          Text(
            'Place bid of ${formatCurrency(amount)} on ${product.title}?',
            style: AppTypography.body,
          ...
          ThriftButton(
            ...
            onPressed: () async {
              final buyerId =
                  context.read<AuthProvider>().user?.id ?? 'buyer_maya';
